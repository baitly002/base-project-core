...
import org.basecode.common.generator.mybatis.generator.config.*;
import org.basecode.common.generator.mybatis.generator.internal.rules.ConditionalModelRules;
import org.basecode.common.generator.mybatis.generator.internal.rules.FlatModelRules;
import org.basecode.common.generator.mybatis.generator.internal.rules.HierarchicalModelRules;
import org.basecode.common.generator.mybatis.generator.internal.rules.Rules;

import java.util.*;

import static org.basecode.common.generator.mybatis.generator.internal.util.StringUtility.isTrue;
...
public abstract class IntrospectedTable {
    ...
    /**
     * 修改了生成dao接口中方法的名称与XML（Mapper）文件中的的各id名称
     */
    protected void calculateXmlAttributes() {
        ...
        setCountByExampleStatementId(tableConfiguration.getProperty("conf_count")); //$NON-NLS-1$
        setDeleteByExampleStatementId(tableConfiguration.getProperty("conf_delete")); //$NON-NLS-1$
        setDeleteByPrimaryKeyStatementId(tableConfiguration.getProperty("conf_deleteByPrimaryKey")); //$NON-NLS-1$
        setInsertStatementId(tableConfiguration.getProperty("conf_insert")); //$NON-NLS-1$
        setInsertSelectiveStatementId(tableConfiguration.getProperty("conf_insertSelective")); //$NON-NLS-1$
        setSelectAllStatementId(tableConfiguration.getProperty("conf_selectAll")); //$NON-NLS-1$
        setSelectByExampleStatementId(tableConfiguration.getProperty("conf_select")); //$NON-NLS-1$
        setSelectOneStatementId(tableConfiguration.getProperty("conf_selectOne"));
        setSelectByExampleWithBLOBsStatementId(tableConfiguration.getProperty("conf_selectWithBLOBs")); //$NON-NLS-1$
        setSelectByPrimaryKeyStatementId(tableConfiguration.getProperty("conf_selectByPrimaryKey")); //$NON-NLS-1$
        setUpdateByExampleStatementId(tableConfiguration.getProperty("conf_update")); //$NON-NLS-1$
        setUpdateByExampleSelectiveStatementId(tableConfiguration.getProperty("conf_updateSelective")); //$NON-NLS-1$
        setUpdateByExampleWithBLOBsStatementId(tableConfiguration.getProperty("conf_updateWithBLOBs")); //$NON-NLS-1$
        setUpdateByPrimaryKeyStatementId(tableConfiguration.getProperty("conf_updateByPrimaryKey")); //$NON-NLS-1$
        setUpdateByPrimaryKeySelectiveStatementId(tableConfiguration.getProperty("conf_updateByPrimaryKeySelective")); //$NON-NLS-1$
        setUpdateByPrimaryKeyWithBLOBsStatementId(tableConfiguration.getProperty("conf_updateByPrimaryKeyWithBLOBs")); //$NON-NLS-1$
        setBaseResultMapId(tableConfiguration.getProperty("conf_BaseResultMap")); //$NON-NLS-1$
        setResultMapWithBLOBsId(tableConfiguration.getProperty("conf_ResultMapWithBLOBs")); //$NON-NLS-1$
        setExampleWhereClauseId(tableConfiguration.getProperty("conf_Where_Clause")); //$NON-NLS-1$
        setBaseColumnListId(tableConfiguration.getProperty("conf_Base_Column_List")); //$NON-NLS-1$
        setBlobColumnListId(tableConfiguration.getProperty("conf_Blob_Column_List")); //$NON-NLS-1$
        setMyBatis3UpdateByExampleWhereClauseId(tableConfiguration.getProperty("conf_Update_Where_Clause")); //$NON-NLS-1$
    }
    ...
    protected String calculateJavaModelPackage() {
        ...
        String modelPackage = config.getProperty("modelPackage");
