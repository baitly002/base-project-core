 ...
 */
package org.basecode.common.generator.mybatis.generator.codegen.mybatis3.javamapper.elements.sqlprovider;
...
public class ProviderUpdateByExampleSelectiveMethodGenerator extends
    ...
    public void addClassElements(TopLevelClass topLevelClass) {
        ...
        importedTypes.add(new FullyQualifiedJavaType("java.utils.Map")); //$NON-NLS-1$
        
        Method method = new Method(introspectedTable.getUpdateByExampleSelectiveStatementId());
        method.setReturnType(FullyQualifiedJavaType.getStringInstance());
        method.setVisibility(JavaVisibility.PUBLIC);
        method.addParameter(new Parameter(new FullyQualifiedJavaType("java.utils.Map<java.lang.String, java.lang.Object>"), //$NON-NLS-1$
                "parameter")); //$NON-NLS-1$
