...
import org.basecode.common.generator.mybatis.generator.api.dom.java.InnerClass;
...
public class ExampleGenerator extends AbstractJavaGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        FullyQualifiedJavaType fqjt = new FullyQualifiedJavaType(
                "java.utils.List<Criteria>"); //$NON-NLS-1$
        field.setType(fqjt);
    ...
    private InnerClass getGeneratedCriteriaInnerClass(
        ...
        FullyQualifiedJavaType listOfCriterion = new FullyQualifiedJavaType(
                "java.utils.List<Criterion>"); //$NON-NLS-1$
        ...
        FullyQualifiedJavaType listOfDates = new FullyQualifiedJavaType(
                "java.utils.List<java.utils.Date>"); //$NON-NLS-1$
    ...
    private String addtypeHandledObjectsAndMethods(
        ...
        Field field = new Field();
        field.setVisibility(JavaVisibility.PROTECTED);
        field.setType(new FullyQualifiedJavaType("java.utils.List<Criterion>")); //$NON-NLS-1$
