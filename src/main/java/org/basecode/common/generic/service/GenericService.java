package org.basecode.common.generic.service;
...
public interface GenericService<T extends Serializable>{
     ...
     * 统计数量
     */
//    @RequestMapping(value="/count/", method=HttpMethod.GET)
    public int countBase(Map<String, Object> map);

    /**
     * 自定义删除
     */
//	@RequestMapping(value="/selective/", method=HttpMethod.DELETE)
...
//    @RequestMapping(value="/", method=HttpMethod.GET)
    ...
    //以下代码来自mybatis-plus的IService类定义
    /**
     * 默认批次提交数量
     */
     ...
     * @param entity 实体对象
     */
    boolean saveOrUpdatePlus(T entity);
    ...
    /**
     * <p>
     * 根据updateWrapper尝试更新，否继续执行saveOrUpdatePlus(T)方法
    ...
    default boolean saveOrUpdate(T entity, Wrapper<T> updateWrapper) {
        return update(entity, updateWrapper) || saveOrUpdatePlus(entity);
    }
}